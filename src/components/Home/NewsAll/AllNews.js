    ...
    return (
        <section className="mb-5">
            ...
            <div className="d-flex">
                <div className="col-md-3 pb-5 border-primary bg-warning text-center text-dark flex-column d-flex">
                    <h1 className="mb-5 text-uppercase p-5">News of Auto Brands</h1>
